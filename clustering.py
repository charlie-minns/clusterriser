...
def main():
    ...
    #y0 = 1180
    #estimate = [A, x0, y0]
    #popt, pcov = optimize.curve_fit(fit, alphas, dist, estimate)
    #A, x0, y0 = popt
    #fit_plot = fit(alphas, A, x0, y0)
    #fig2 = plt.figure()
    #ax2 = fig2.add_subplot(111, aspect='equal')
    #ax2.plot(alphas, distance)
    #ax2.plot(alphas, fit_plot)
    #ax2.set_title("How Distance Changes with Alpha with Approximate Fit")
